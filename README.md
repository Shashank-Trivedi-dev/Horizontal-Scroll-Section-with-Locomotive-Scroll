## Welcome to  [ # Horizontal scroll section with GSAP ScrollTrigger & Locomotive Scroll ]  HTML Code Sections

## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Horizontal-Scroll-Section-with-Locomotive-Scroll )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/NWeagza )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Horizontal-Scroll-Section-with-Locomotive-Scroll )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/Horizontal-Scroll-Section-with-Locomotive-Scroll/ )
